...
declare type ExecFn = typeof exec;
...
declare const exec: (cmd: string, opts?: {}) => Buffer;
export declare const spawnPipe: (pgDump: ChildProcess, pgRestore: ChildProcess) => Promise<void>;
export declare const verifyExtensionsMatch: (source: pg.ConnectionDetails, target: pg.ConnectionDetails) => Promise<void>;
export {};
