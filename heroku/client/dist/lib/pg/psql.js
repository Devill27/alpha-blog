...
export async function fetchVersion(db) {
...
export function psqlFileOptions(file, dbEnv) {
...
export function psqlInteractiveOptions(prompt, dbEnv) {
...
export async function execFile(db, file) {
    const psqlService = new utils.pg.PsqlService(db);
...
export async function interactive(db) {
    const psqlService = new utils.pg.PsqlService(db);
