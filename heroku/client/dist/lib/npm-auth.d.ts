...
export declare class NpmAuth {
    /**
     * Execute a command - extracted for testability
     */
    static exec(command: string, options?: any): Promise<{
     ...
     */
    static isNpmAvailable(): Promise<boolean>;
    /**
     ...
     */
    static isPrivatePackage(packageName: string): Promise<boolean>;
    /**
